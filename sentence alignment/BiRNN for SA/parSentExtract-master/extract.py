...
def extract_pairs(sess, source_sentences, target_sentences,
    ...
    for score, k in y_score:
        ...
        print(i, j, score)
            ...
            #continue
        if i in i_aligned or j in j_aligned:
            continue    
        if FLAGS.use_greedy:
            i_aligned.add(i)
            j_aligned.add(j)
    ...
    with tf.Session() as sess:
        ...
        with open(FLAGS.source_output_path, mode="w", encoding="utf-8") as source_output_file,\
            ...
            for source_path, target_path in zip(source_paths, target_paths):
                ...
                print('sids', source_sentences_ids)
                print('tids', target_sentences_ids)
